...
Статус: **in-progress**, фаза E0. Канонический handoff: [`empryo-port/STATE.md`](empryo-port/STATE.md). Решения и roadmap: [`empryo-port/README.md`](empryo-port/README.md).
