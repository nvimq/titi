...
1l. Чего ещё нет: скиллы/hooks/MCP (E6), вкладки (в Empryo до 5), стоимость в USD (нет цен провайдеров), STT. Настоящая модель эмбеддингов — когда записей станет больше, чем влезает в промпт; интерфейс `embed()` уже изолирован.
